...
templates['cpp'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(alias1,(helpers.ne || (depth0 && depth0.ne) || alias2).call(alias1,(data && data.index),0,{"name":"ne","hash":{},"data":data}),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    ...
    + "        printf(\""
    + ((stack1 = ((helper = (helper = helpers.end || (depth0 != null ? depth0.end : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"end","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\\n\");\n        fflush(stdout);\n        \n";
  ...
  return "#include <cstdio>\n\nint N, K;\nchar header[20], grader[20];\n\nint main() {\n    scanf(\"%s\", header);\n"
    + ((stack1 = helpers["if"].call(alias1,(helpers.ne || (depth0 && depth0.ne) || helpers.helperMissing).call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.length : stack1),0,{"name":"ne","hash":{},"data":data}),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "")
    + "}";
},"useData":true});
templates['pascal'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(alias1,(helpers.ne || (depth0 && depth0.ne) || alias2).call(alias1,(data && data.index),0,{"name":"ne","hash":{},"data":data}),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.middle : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        writeln('"
    + ((stack1 = ((helper = (helper = helpers.end || (depth0 != null ? depth0.end : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"end","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "');\n        flush(output);\n        \n";
},"3":function(container,depth0,helpers,partials,data) {
    return "    end else if ";
},"5":function(container,depth0,helpers,partials,data) {
